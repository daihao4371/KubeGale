...
import (
	"KubeGale/global"
	model "KubeGale/model/kubernetes/cluster"
...
func (t *NodeTTYService) Get(nodetty kubernetesReq.NodeTTY, uuid uuid.UUID) (podMsg *PodMessage, err error) {
	...
	if err != nil {
		global.KUBEGALE_LOG.Error("get user info failed: " + err.Error())
		return podMsg, err
	}
	...
	if err != nil {
		global.KUBEGALE_LOG.Error("Node shell Pod Message failed: " + err.Error())
		return podMsg, err
	}
