...
const tableData = ref([])
const title = ref('')
const searchInfo = ref<{ keywords: string; cluster_id: string | number }>({ keywords: '', cluster_id: '' })
const cluster_list = ref<{ id: string | number; name: string }[]>([])
const router = useRouter()
// 搜索
const onReset = () => {
  searchInfo.value = { keywords: '', cluster_id: '' }
}
