// to unit `m`
export function cpuUnitConvert(value: string) {
...
// to unit `Mi`
export function memoryUnitConvert(value: string) {
...
export function giMemoryFormat(value: string) {
    if (value == null) {
        return ''
    }
    if (value.indexOf('Ki') !== -1) {
...
export function CpuFormat(value: string) {
    if (value == null) {
        return ''
    }
    if (value.indexOf('u') !== -1) {
